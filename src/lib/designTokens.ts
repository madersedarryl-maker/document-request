...
export const STATUS_CONFIG: Record<RequestStatus, StatusStyleConfig> = {
  SUBMITTED: {
    label: 'Submitted',
  ...
  UNDER_REVIEW: {
    ...
    badgeBorder: 'border-amber-300/80 shadow-2xs',
    iconName: 'Clock',
  ...
  FOR_APPROVAL: {
    ...
    badgeText: 'text-indigo-800 font-semibold',
  ...
  APPROVED: {
    ...
    badgeBorder: 'border-emerald-200 shadow-2xs',
  ...
  PROCESSING: {
    ...
    badgeText: 'text-cyan-900 font-semibold',
    badgeBorder: 'border-cyan-300 shadow-2xs',
    iconName: 'Package',
    dotColor: 'bg-cyan-600 animate-pulse',
    kpiColor: 'text-cyan-700',
  },
  READY_FOR_RELEASE: {
  ...
  RELEASED: {
    ...
    badgeBorder: 'border-teal-300 shadow-2xs',
    iconName: 'CheckCircle2',
    dotColor: 'bg-teal-600',
    kpiColor: 'text-teal-700',
  },
  REJECTED: {
    label: 'Rejected',
