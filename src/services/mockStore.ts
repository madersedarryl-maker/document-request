...
const INITIAL_STATUS_HISTORY: RequestStatusHistory[] = [
  // req-2026-001 (SUBMITTED)
  {
    ...
    reason: undefined,
    comment: 'Request submitted online by student via student portal.',
    created_at: '2026-08-20T09:15:00.000Z',
    changed_by_user: {
  ...
  // req-2026-002 (NEEDS_INFORMATION)
  {
    id: 'hist-002-1',
  ...
  },
  {
    ...
    reason: undefined,
    comment: 'Evaluating requirements, graduation credentials, and accounting clearance.',
  ...
  // req-2026-003 (PROCESSING)
  {
    id: 'hist-003-1',
    request_id: 'req-2026-003',
    previous_status: undefined,
    new_status: 'SUBMITTED',
    changed_by: 'usr-student-002',
    reason: undefined,
    comment: 'Good Moral Certificate request submitted online by student.',
    created_at: '2026-08-16T11:00:00.000Z',
    changed_by_user: {
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Prefect of Discipline and Student Affairs clearance records verified.',
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Endorsed to Dean of Student Affairs for formal signing.',
  ...
  },
  {
    id: 'hist-003-4',
    request_id: 'req-2026-003',
    previous_status: 'FOR_APPROVAL',
    new_status: 'APPROVED',
    changed_by: 'usr-admin-001',
    reason: undefined,
    comment: 'Request approved by Dean of Student Affairs & Chief Registrar.',
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Certificate generated with official seal. Packaging for authorized release.',
  ...
  // req-2026-004 (READY_FOR_RELEASE)
  {
    id: 'hist-004-1',
    ...
    changed_by: 'usr-student-001',
    reason: undefined,
    comment: 'Request filed online by student.',
    created_at: '2026-08-12T08:30:00.000Z',
    changed_by_user: {
      full_name: INITIAL_PROFILES[0].full_name,
      role: INITIAL_PROFILES[0].role,
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Transcript and Diploma archives matched and verified.',
  ...
  },
  {
    ...
    changed_by: 'usr-admin-001',
    reason: undefined,
    comment: 'Certification approved by University Registrar.',
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Printing dry seals and holographic security stickers applied.',
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Document printed, stamped, sealed, and ready at Registrar Window 3.',
  ...
  // req-2026-005 (RELEASED)
  {
    id: 'hist-005-1',
    request_id: 'req-2026-005',
    previous_status: undefined,
    new_status: 'SUBMITTED',
    changed_by: 'usr-student-003',
    reason: undefined,
    comment: 'Certificate of Grades requested online.',
    created_at: '2026-08-08T09:00:00.000Z',
    changed_by_user: {
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Semester grades verified and approved.',
  ...
  },
  {
    ...
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Signed and ready for student pickup.',
  ...
  },
  {
    id: 'hist-005-4',
    request_id: 'req-2026-005',
    previous_status: 'READY_FOR_RELEASE',
    new_status: 'RELEASED',
    changed_by: 'usr-staff-001',
    reason: undefined,
    comment: 'Claimed and signed by student Alex Rivera in person.',
